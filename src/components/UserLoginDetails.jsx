...
const UserLoginDetails = () => {
  ...
  const isError = valid === false && submitted === true;
      ...
      <Box w="800px" mx="auto">
        ...
        <form onSubmit={handleSubmit}>
          <FormControl isRequired color="black" isInvalid={isError}>
            ...
            />
            {isError ? (
              <FormErrorMessage>Неверный Email или номер телефона</FormErrorMessage>
            ) : null}
          </FormControl>
          ...
          <FormControl isRequired color="black" mt="25px" isInvalid={isError}>
            ...
            <Input
              ...
              _hover={{ borderColor: 'blue.300' }}
            />
            {isError ? <FormErrorMessage>Неверный пароль</FormErrorMessage> : null}
          </FormControl>
